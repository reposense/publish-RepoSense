...
./get-reposense.py --master --overwrite
...
java -jar RepoSense.jar -repos https://github.com/reposense/RepoSense.git https://github.com/MarkBind/markbind.git --ignore-standalone-config
